...
- [Different format of data](#different-format-of-data)
    - [Image](#image)
    - [Video](#video)
    - [Audio](#audio)
    - [Text](#text)
- [Model](#model)
    ...
    - [Error/Cost and Optimization](#errorcost-and-optimization)
    - [Linear Regression](#linear-regression)
    - [Practical Example](#practical-example-4)
    - [Minimum to Mean distance classifier](#minimum-to-mean-distance-classifier)
    - [Practical Example](#practical-example-5)
    - [K-Means Clustering](#k-means-clustering)
    - [Practical Example](#practical-example-6)
    - [Overfitting](#overfitting)
      - [Flexibility of the model](#flexibility-of-the-model)
      - [Generalization and Validation Set](#generalization-and-validation-set)
      - [Accuracy](#accuracy)
...
To view an example of overfitting, click [Here](/Machine%20Learning%20Crash/practice/high_capacity_problem/overfitting.ipynb)
